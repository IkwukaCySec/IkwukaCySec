...
1. **Phishing Buster Tool** – Python script scans URLs via VirusTotal API. Reduced false positives by 30% in sims.
   - <img src="https://via.placeholder.com/300x200/FF6B6B/FFFFFF?text=Phishing+Alert+Demo" alt="Screenshot: CLI Output Detecting Malicious URL">
...
2. **MITRE ATT&CK Navigator** – Custom dashboard mapping threats to detections.
   ...
   - <img src="https://via.placeholder.com/600x300/4ECDC4/000000?text=ATT&CK+Heatmap:+TTPs+Visualized" alt="Interactive ATT&CK Matrix Screenshot">

3. **FortiGate Config Generator** – Bash automation for secure firewall rules.
   - Stars: Aim for 5+ via shares. <img src="https://img.shields.io/github/stars/IkwukaCySec/IkwukaCySec?color=green" alt="Star Badge">
